...
pin 'rails_admin/src/rails_admin/base', to: 'https://ga.jspm.io/npm:rails_admin@3.2.0-rc/src/rails_admin/base.js'
...
pin '@rails/actioncable/src', to: 'https://ga.jspm.io/npm:@rails/actioncable@7.2.100/src/index.js'
